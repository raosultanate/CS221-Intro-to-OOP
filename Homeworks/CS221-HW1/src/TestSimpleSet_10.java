 ...
 * Tests for Scenario: [A,B,C] -> remove(B) -> [A,C]
 *
 * @author CS221
 */
public class TestSimpleSet_10
{
	...
	private static final Object[][] VALID_ELEMENTS = { {SetTestCase.A}, {SetTestCase.C} };
	 ...
	 * - whether set contains an element (E) not in set
	 * Expected Result: False
	 */
	@Test
	...
	/**
	 * Test: add(ELEMENT) - adds an element (E) to set
	 * Expected Result: No exceptions 
	 */
	@Test
