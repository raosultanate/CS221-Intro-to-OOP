 ...
 * Tests for Scenario: [A,B,C] -> remove(C) -> [A,B]
 *
 * @author CS221
 */
public class TestSimpleSet_11
{
	...
	private static final Object[][] VALID_ELEMENTS = { {SetTestCase.A}, {SetTestCase.B} };
