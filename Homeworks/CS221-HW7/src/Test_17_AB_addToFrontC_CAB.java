 ...
 * Tests for Change Scenario 17: [A, B] -> addToFront(C) -> [C, A, B]
 * 
 * @author Daniel Rao
 */
public class Test_17_AB_addToFrontC_CAB
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.C}, {TestCase.A}, {TestCase.B} };
		// First element in list
		private static final Character FIRST = TestCase.C;
		// Last element in list 
		private static final Character LAST = TestCase.B;	
		// Elements in list with indexes
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.C}, {1, TestCase.A}, {2, TestCase.B} };
