...
/**
 * Testing for IndexedUnsortedList interface implementation: Tests for Change
 * Scenario 8: [A] -> addAfter(B) -> [A, B]
 * 
 * @author Daniel Rao
 */
public class Test_8_A_addAfterBA_AB {
	...
	/**
	 * Sets up list for testing: uses Parameter in XML file to select the dynamic
	 * type of the list.
	 * 
	...
	// ******************* Tests ***************************
	/**
	 * Test: removeFirst() - remove first element of list Expected Result: Reference
	 * to first element (B)
	 */
	@Test
	...
	/**
	 * Test: removeLast() - remove last element of list Expected Result: Reference
	 * to last element (A)
	 */
	@Test
	...
	/**
	 * Test: remove(X) - remove elements X from list Expected Result: Reference to
	 * elements X
	 */
	...
	/**
	 * Test: first() - returns reference to first element Expected Result: Reference
	 * to first element (B)
	 */
	@Test
	...
	/**
	 * Test: last() - returns reference to last element Expected Result: Reference
	 * to last element (A)
	 */
	@Test
	...
	/**
	 * Test: contains(X) - whether list contains valid elements X Expected Result:
	 * true
	 */
	@Test(dataProvider = "validElements")
	...
	/**
	 * Test: isEmpty() - whether list is empty Expected Result: false
	 */
	@Test
	...
	/**
	 * Test: size() - number of elements in list Expected Result: SIZE (2)
	 */
	@Test
	 ...
	 */
	/*
	 * @Test public void testToString() { TestCase.toString(list); }
	 */

	/**
	 * Test: iterator() - an Iterator object Expected Result: Reference to Iterator
	 * object
	 */
	@Test
	...
	/**
	 * Test: listIterator() - a ListIterator object Expected Result:
	...
	/**
	 * Test: listIterator(INDEX) - a ListIterator object Expected Result:
	 * UnsupportedOperationException
	 */
	...
	/**
	 * Test: addToFront(ELEMENT) - adds element (E) to front of list Expected
	 * Result: No Exception
	 */
	@Test
	...
	/**
	 * Test: addToRear(ELEMENT) - adds element (E) to back of list Expected Result:
	 * No Exception
	 */
	@Test
	...
	/**
	 * Test: addAfter(ELEMENT, INVALID_ELEMENT) - adds element (E) after an invalid
	 * element (F) in the list Expected Result: NoSuchElementException
	 */
	@Test(expectedExceptions = NoSuchElementException.class)
	...
	/**
	 * Test: add(X, ELEMENT) - adds element (E) at valid indexes X Expected Result:
	 * No Exception
	 */
	...
	/**
	 * Test: add(X, ELEMENT) - adds element (E) at invalid indexes X Expected
	...
	/**
	 * Test: remove(X) - removes elements at valid indexes X Expected Result:
	 * Reference to elements at valid indexes X
	 */
	...
	/**
	 * Test: remove(X) - removes elements at invalid indexes X Expected Result:
	...
	/**
	 * Test: set(X, ELEMENT) - sets value of element at valid indexes X to element
	 * (E) Expected Result: No Exception
	 */
	...
	/**
	 * Test: set(X, ELEMENT) - tries to set value of element at invalid indexes X to
	 * element (E) Expected Result: IndexOutOfBoundsException
	 */
	@Test(dataProvider = "invalidIndexes", expectedExceptions = IndexOutOfBoundsException.class)
	...
	/**
	 * Test: add(ELEMENT) - adds element to the end of the list Expected Result: No
	 * exception
	 */
	@Test
	public void testAdd() {
	...
	/**
	 * Test: get(X) - returns reference to element at valid indexes X Expected
	 * Result: Reference to element at valid indexes X
	 */
	@Test(dataProvider = "indexedValidElements")
	...
	/**
	 * Test: indexOf(X) - returns index of valid elements X Expected Result: Index
	 * of elements X
	 */
	@Test(dataProvider = "indexedValidElements")
	 ...
	 * 
	 * @return 2D array (second dimension empty) indexes of elements in the list
	 */
	@DataProvider
	 ...
	 * 
	 * @return 2D array (second dimension empty) indexes of list where elements can
	 *         be added. Note: can add element one past the last element in the
	 *         list.
	 */
	@DataProvider
	 ...
	 * 
	 * @return 2D array (second dimension empty) indexes of list where elements
	 *         can't be added. Note: can add element one past the last element in
	 *         the list, so first invalid index is two past this element.
	 */
	@DataProvider
